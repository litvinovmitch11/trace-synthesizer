...
def main():
    ...
    cfg_base, comp_base, ref_base = build_artifacts(PROG_BASE, BUILD_BASE, "smart_base")
    cfg_mut, comp_mut, ref_mut = build_artifacts(PROG_MUTATED, BUILD_MUTATED, "smart_mutated")
